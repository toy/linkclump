(function () {
  ...
  function start() {
    ...
    let re2 = new RegExp(settings[setting].options.ignore.slice(1).join('|'), 'i');
    ...
    for (let i = 0; i < page_links.length; i++) {
      ...
      page_links[i].important =
        settings[setting].options.smart == 0 &&
